        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttackEffect = table.Column<bool>(nullable: false),
                    EnduranceEffect = table.Column<bool>(nullable: false),
                    HealsPlayer = table.Column<bool>(nullable: false),
                    LuckEffect = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ZombieId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ChanceToDrop = table.Column<int>(nullable: false),
                    ExperienceValue = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    ZombieAttack = table.Column<int>(nullable: false),
                    ZombieHealth = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemId = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    SpawnEnemy = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Expierience = table.Column<int>(nullable: false),
                    LocationId = table.Column<int>(nullable: false),
